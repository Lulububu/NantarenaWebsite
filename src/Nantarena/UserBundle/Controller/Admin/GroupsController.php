 ...
 *
 * @package Nantarena\UserBundle\Controller\Admin
 *
 * @Route("/admin/groups")
 */
...
{
    /**
     * @Route("/", name="nantarena_user_admin_groups")
     * @Template()
     */
    ...
    /**
     * @Route("/create", name="nantarena_user_admin_groups_create")
     * @Template()
     */
    public function createAction(Request $request)
    {
        $groupManager = $this->get('fos_user.group_manager');
        $groupType = $this->get('nantarena_user.groups.group_type');
        $group = $groupManager->createGroup("");

        $form = $this->createForm($groupType, $group, array(
            'action' => $this->generateUrl('nantarena_user_admin_groups_create'),
            'method' => 'POST',
        ));
        ...
        if ($form->isValid()) {
            ...
            try {
                ...
                return $this->redirect($this->generateUrl('nantarena_user_admin_groups'));
    ...
    /**
     * @Route("/edit/{id}", name="nantarena_user_admin_groups_edit")
     * @Template()
     */
    public function editAction(Request $request, Group $group)
    {
        ...
        $form = $this->createForm($groupType, $group, array(
            'action' => $this->generateUrl('nantarena_user_admin_groups_edit', array(
                'id' => $group->getId()
            )),
            'method' => 'POST',
        ));
        ...
        if ($form->isValid()) {
            ...
            try {
                ...
                return $this->redirect($this->generateUrl('nantarena_user_admin_groups_edit', array(
                    'id' => $group->getId()
                )));
    ...
    /**
     * @Route("/delete/{id}", name="nantarena_user_admin_groups_delete")
     * @Template()
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder(array('id' => $id))
            ...
            ->add('submit', 'submit')
            ->setMethod('POST')
            ->setAction($this->generateUrl('nantarena_user_admin_groups_delete', array(
                'id' => $id
            )))
            ->getForm();
    }
