...
{
    /**
     * @Route("/", name="nantarena_user_admin_users")
     * @Template()
     */
    ...
    /**
     * @Route("/create", name="nantarena_user_admin_users_create")
     * @Template()
     */
    public function createAction(Request $request)
    {
        ...
        $form = $this->createForm(new AddUserType(), $user, array(
            'action' => $this->generateUrl('nantarena_user_admin_users_create'),
            'method' => 'POST',
        ));
    ...
    /**
     * @Route("/edit/{id}", name="nantarena_user_admin_users_edit")
     * @Template()
     */
    ...
    /**
     * @Route("/delete/{id}", name="nantarena_user_admin_users_delete")
     * @Template()
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder(array('id' => $id))
            ...
            ->add('submit', 'submit')
            ->setMethod('POST')
            ->setAction($this->generateUrl('nantarena_user_admin_users_delete', array(
                'id' => $id
            )))
            ->getForm();
    }
